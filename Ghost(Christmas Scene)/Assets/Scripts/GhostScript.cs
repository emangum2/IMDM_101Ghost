...
public class GhostScript : MonoBehaviour
{
         ...
         if (Anim.GetCurrentAnimatorStateInfo(0).fullPathHash == MoveState)
    {
        ...
        {
            MOVE_Velocity(new Vector3(0, 0, Speed), Vector3.zero); // Move Up
        }
        else if (Input.GetKey(KeyCode.DownArrow))
        {
            MOVE_Velocity(new Vector3(0, 0, -Speed), new Vector3(0, 180, 0)); // Move Down
        }
        else if (Input.GetKey(KeyCode.LeftArrow))
        {
            MOVE_Velocity(new Vector3(-Speed, 0, 0), new Vector3(0, -90, 0)); // Move Left
        }
        else if (Input.GetKey(KeyCode.RightArrow))
        {
            MOVE_Velocity(new Vector3(Speed, 0, 0), new Vector3(0, 90, 0)); // Move Right
        }
    }
        KEY_DOWN();
        KEY_UP();
